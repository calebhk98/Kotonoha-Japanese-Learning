...
**plot**: 専門学校の初日。勇介は18〜23歳の同級生に囲まれ、完全に浮いた存在になる。基礎実習でバターの「ポマード状」が作れず、講師の澤田に「手が冷たい人間には向いていないかもしれませんね」と皮肉を言われる。クラスメートの千夏だけが「最初は誰でもそうだよ」と声をかけてくれる。帰宅して美咲に「やっぱり向いていないかも」と弱音を吐くが、蓮の「パパならできる」の一言で立ち直る。翌日、練習を繰り返してバターをポマード状にすることだけは成功する。たった一つだが、確かな手ごたえ。
...
- ～やすい/にくい「バターは温度が高すぎると扱いにくく、低すぎると伸ばしにくい。」（難易度の説明）[N3必須形・Ep3の実習場面に自然に組み込む]

**emotional beat**: 最初の挫折、そして小さな一歩。帰る場所がある安心感と、翌日に掴んだ小さな手ごたえ。転職した現実が初めて体に刻まれる夜と、それでも続ける朝。
...
**plot**: 貯金が予想より早く減り始め、美咲がデザインの仕事を増やすと言い出す。勇介は感謝と申し訳なさで胸が痛い。そんな中、義雄から突然「東京に行く」と連絡が入る。孫の蓮に会いたいというのが名目だが、実際は息子の様子を確かめに来たのだ。義雄は勇介の専門学校のノートや実習用エプロンを黙って見るが、何も言わない。夕食の場は緊張の沈黙が続く。義雄は食後に蓮と風呂に入りながら何やら長話をしているようで、蓮が後で「おじいちゃん、なんか疲れそうだった」とこぼす。翌朝義雄は何も言わずに帰ってしまう。[執筆注: 義雄の体の疲れ・顔色の変化をこの場面で微かに示しておくこと。Ep7の脳梗塞への伏線。無理に強調せず、後から「そういえば」と読者が気づける程度でよい。]
...
**plot**: 学校の課外プロジェクトで近所のカフェにクリスマスケーキを納品する機会を得る。勇介は張り切りすぎて原価計算を誤り、10個のケーキで3000円の赤字を出してしまう。千夏に「パティシエは芸術家じゃなくて商売人でもある」と厳しく言われ、現実の厳しさを痛感する。帰宅して深夜、勇介がキッチンテーブルで電卓を叩いていると、美咲が起きてきてそっと隣に座る。「私、やっと分かったかもしれない。あなたがやめられない理由」と一言だけ言って、一緒に計算を手伝い始める。その夜の二人の静けさが、以前とは違う。そして翌日、カフェのオーナーから「また頼みたい。今度はちゃんと値段を計算して」と言われ、次への希望が生まれる。
...
- ～ものだ「プロの仕事というのは、こういうものだと、千夏は静かに言った。」（一般的道理・感慨）[N3必須形・千夏の台詞か地の文に組み込む]

**emotional beat**: 夢と現実の衝突。それでも次の扉が開く。そして深夜のキッチンで美咲の気持ちが静かに転換する。プロの世界の重さと、それを支える人の温かさを同時に実感するエピソード。
...
**plot**: 義雄が突然脳梗塞で入院する（Ep4での疲れ・顔色の伏線が回収される）。勇介は実習を休んで帰省する。急性期は数日で落ち着くが、勇介はしばらく実家に泊まる。回復期の義雄はベッドの上で、かつて自分も画家になりたかったが父親に反対されて諦めた過去を初めて打ち明ける。「お前の話を聞いて、若い頃の自分を思い出した。だから怒った」と言い、目に涙を浮かべる義雄の手を勇介は黙って握る。[執筆注: 義雄を泣き崩れさせるのは過剰。元・国鉄職員の世代として「目に涙が浮かぶが声は出さない」程度に抑えること。感情の抑制が逆に重さを増す。] 父子の和解は言葉ではなく、握った手と長い沈黙で描く。義雄は数日後、「うまいケーキを食わせてくれ」と言い始める。
...
- ～ものだ（感慨・一般的真理）「人生というのは、諦めなければ少しずつ変わっていくものだ、と勇介はようやく信じられるようになった。」[N3必須形・Ep8の締めの地の文として使用。Ep6で千夏が用いた用法と対になる]
...
### Continuity Risks
- **財政状況のトラッキング**: Ep2で退職→Ep4で貯金減少→Ep6で赤字納品と、経済的緊張を段階的に高める設計になっている。各話で貯金残高や美咲の仕事量に関する具体的言及を一貫させること。数字を出す場合は話をまたいで矛盾しないよう注意。**未解決の現実的問題: 製菓専門学校の学費（一般的に年間100〜150万円）への言及がシリーズ全体で欠けている。** Ep2か Ep3で、「一年間の学費と生活費の見積もり」として1〜2文触れること。貯金から賄う設計なら、Ep4の「予想より早く減っている」という焦りがより納得感を持つ。学費を無視すると、経済的リアリズムを重視するこの物語の土台が弱くなる。
...
- **追加済み文型（レビュー修正）**: ～やすい/にくい をEp3に追加（実習場面の技術説明として自然）。～ものだ をEp6とEp8の両方に追加（千夏の発言とEp8の締めの地の文として機能する）。これでN3必須文型の網羅率が改善された。

### Character Consistency Issues
- 勇介は「内向的だが頑固」という性格設定。一度決めたら揺らがない芯の強さと、人前では感情を出せない不器用さを両立させること。Ep5で涙をこらえる描写はこの性格に合致している。
- 美咲は「賛成でも反対でもない現実主義者」として始まるが、Ep5・Ep8で徐々に感情的サポートに傾く。**この転換点はEp6（深夜のキッチンシーン）に組み込んだ（プロット修正済み）。** Ep6で美咲が「あなたがやめられない理由がわかった」と言う場面が、彼女の内面的転換点として機能する。Ep5とEp7の間に位置しており、説得力のある変化の流れが確保された。
...
### Kanji Usage
- 中学卒業〜高校1年生程度までの常用漢字を中心に使用する。それを超える漢字（目安：常用漢字表の後半・2000字超の範囲）には必要に応じてルビを振る（例：脳梗塞（のうこうそく））。[注: JLPT2010年改定以降、漢字の公式レベル区分は廃止されている。「N2レベルの漢字」という表現は公式には存在しないため、難易度は常用漢字表の学年・頻度基準で判断すること]
...
**Reviewed by**: カリキュラムレビュー / 2026-05-12
**Status**: APPROVED WITH REVISIONS

### Summary
8話構成として構造はしっかりしており、N3向けシリアルストーリーとして公開できる水準に達している。キャラクター設計・感情アーク・エピソード間の連続性はよく考えられている。以下の修正を加えた上で承認。

### Revisions Made (CRITICAL — fixed in this review)
1. **美咲の態度転換に場面を与えた（Ep6プロット修正）**: 「賛成でも反対でもない現実主義者」から「夫を心から支える立場」への転換が、Ep6の深夜キッチンシーンで明示されるよう追記した。プロット上の人物弧として最も重要な修正。
2. **義雄の脳梗塞への伏線を追加（Ep4プロット修正）**: Ep7の脳梗塞が突然の「都合のいい装置」に見えないよう、Ep4訪問時に疲れ・顔色への微妙な言及を入れる執筆注を追加した。

### Revisions Made (IMPORTANT — fixed in this review)
3. **Ep3に小さな成功場面を追加**: Ep3→Ep4の連続苦境がリーダー疲れを起こす構造だったため、Ep3末尾に「翌日、バターのポマード状だけは成功した」という微小達成を追加し、感情的なリズムを整えた。
4. **Ep3に～やすい/にくいを追加**: Ep3の文法がほぼN4（～ながら、～ておく、～てきた）で、N3パターンが～らしいのみだった。製菓実習という文脈で最も自然な形で～やすい/にくいを追加し、N3文法密度を向上させた。
5. **Ep8に～ものだを追加**: 最終話の4文型がすべて既出パターンの再使用で、新しいN3形が一つも導入されていなかった。締めの地の文として～ものだ（感慨・一般的真理）を追加し、文法的な着地点を作った。
6. **Ep6に～ものだを追加（二重展開）**: Ep6で千夏が使う場面も追加し、Ep8での勇介自身の使用と対にすることで、この文型が「師から学ぶ → 自分のものにする」という学習弧を体現するよう設計した。
7. **専門学校学費の言及を追記（財政リアリズム）**: 経済的緊張が重要テーマにもかかわらず、学費（年間100〜150万円規模）への言及が全話でなかった。Ep2またはEp3での言及を継続リスク注記に追加した。
8. **義雄Ep7の感情描写を調整**: 「泣き崩れる」は元・国鉄職員（終身雇用世代の67歳男性）としてキャラクターと乖離。「目に涙が浮かぶが声は出さない」に改め、世代・性格設定と整合させた。執筆注として明記。

### Revisions Made (MINOR — fixed in this review)
9. **漢字難易度の表現を修正**: 「N3〜N2レベルの漢字」というJPLT廃止後に根拠のない表現を、「常用漢字表の学年・頻度基準」による記述に改めた。

### Remaining Issues (Human Review Needed)
- **～かのようだ**: N3目標文型として挙げられているが全8話に登場しない。比喩的表現としてEp5またはEp7に入れることが可能だが、無理に詰め込むと文章が人工的になる。執筆時の判断に委ねる。
- **～ようとする**: 同上。Ep2の決断シーン（「やってみようとする気持ち」）に使える余地があるが、～てみる と意味が近いため重複感が出る可能性がある。
- **Ep3/Ep4の学費言及**: 具体的な金額・資金計画の描写は、執筆者がエピソード本文を書く際に実際の設定として確定させること。プランでは指示のみ。
- **美咲の勤務形態の一貫性**: 「パート勤務のデザイナー」（キャスト定義）が、Ep4では「デザインの仕事を増やす」とある。増やせる余地があるなら最初からパートを超えているか、副業デザイナー的な働き方を明確化すべき。設定の細部は執筆時に固めること。
